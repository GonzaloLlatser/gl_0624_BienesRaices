    ...
    <div class="contenedor-anuncios">
      ...
      <div class="anuncio">
        <picture>
          ...
          <img loading="lazy" alt="build/img/anuncio4.jpg" alt="anuncio" />
        </picture>
        <div class="contenido-anuncio">
          <h3>Casa urbana</h3>
          <p>
      ...
      <div class="anuncio">
        <picture>
          ...
          <img loading="lazy" alt="build/img/anuncio5.jpg" alt="anuncio" />
        </picture>
        <div class="contenido-anuncio">
          <h3>Villa montega</h3>
          <p>
      ...
      <div class="anuncio">
        <picture>
          ...
          <img loading="lazy" alt="build/img/anuncio6.jpg" alt="anuncio" />
        </picture>
        <div class="contenido-anuncio">
          <h3>Casa artdeco</h3>
          <p>
